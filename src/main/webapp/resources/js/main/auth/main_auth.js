$(function() {
	...
	$('#findID_btn').click(function() {
		alert('1');
		var i_phoneNum = document.querySelector("input[name=i_phoneNum]").value
	    var i_name = document.querySelector("input[name=i_name]").value
		console.log(i_phoneNum)
		console.log(i_name)
	    ...
	    $.ajax({
	        ...
	        data:{i_phoneNum:i_phoneNum,i_name:i_name},
