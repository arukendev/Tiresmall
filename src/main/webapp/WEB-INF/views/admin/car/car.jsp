...
<!-- 	<script type="text/javascript">
		function deleteSize2() {	없어도 문제 없는지 확인절차
...
<body>
	...
	<div class="container sub">
		<div class="car-findselect">
					...
					<form action="car.search.do">
						...
						<div class="car_searchTitle">
							<div class="car_searchID">
								<label for="car_searchid">차종</label> <input id="carnameInput"
			...
			<div class="carRegButton1" style="float: right;">
				<button class="carRegButton" onclick="location.href='admin.car.reg.go'">신규등록</button>
			</div>
		</div>
	</div>
	...
	<table id="admin_car_content">
		<tr>
			...
			<td class="admin_car_content_title admin_car_print"
				style="border-right: 1px solid white;">출력</td>
		...
		<c:forEach items="${cars }" var="c" varStatus="status">
			<tr id="admin_cars_content">
				...
				<td class="admin_car_table_td"><c:choose>
						<c:when test="${c.c_print == 1 }">
							<button class="carprintbtn admin_car_printBTN" value="${c.c_id }">출력</button>
						</c:when>
						<c:otherwise>
							<button class="carprintbtn admin_car_notPrintBTN"
								value="${c.c_id }">미출력</button>
						</c:otherwise>
					</c:choose></td>
				<td class="admin_car_table_td">
					<button class="updatecarbutton"
						onclick="updatecar('${c.c_id}','${c.c_name }','${c.c_year1 }','${c.c_year2 }',
...
<!--  모달창  -->
		...
		<div>
			<form action="reg.car.do" method="post" name="carregform"
				...
				<table border="1" class="modal_table">
					<tr>
						<td style="background-color: #3399ff; text-align: center;">임시
							ID</td>
						<td><input name="c_id" id="c_id"
					...
					<tr>
						...
						<td><input name="c_name" id="c_name"
							style="width: 180px; height: 30px;"></td>
					</tr>
					<tr>
						<td style="background-color: #3399ff; text-align: center;">연식</td>
						<td><input name="c_year1" id="c_year1"
					...
					<tr>
						...
						<td>
							<button type="button" onclick="addSize()"
								class="admin_tire_size_button">사이즈 추가</button> <br>
						<br>
						<br>

							<div class="ftbttmstyle">
								<div class="ftstyle"
									style="height: 30px; width: 200px; border: 1px solid white;">앞타이어</div>
								<div class="btstyle"
									style="height: 30px; width: 200px; border: 1px solid white;">뒤타이어</div>
								<div class="tmstyle"
									style="height: 30px; width: 200px; border: 1px solid white;">관리</div>
							</div>
							<div id="sizeInputs">
								<div style="display: block;">
									<div class="ftinputstyle" style="float: left;">
										<input style="height: 30px; width: 198px;" name="c_ft"
											id="c_ft" class="c_ftinput  jsp-input">
									</div>
									<div class="btinputstyle" style="float: left;">
										<input style="height: 30px; width: 193px;" name="c_bt"
											id="c_bt" class="c_btinput  jsp-input">
									</div>
									<div class="tmreginputstyle" style="float: left;">기본
										타이어입니다.</div>
								</div>
							</div>
						</td>
					...
					<tr>
						...
						<td>
							...
							<div class="fileinputstyle"
								style="float: left; margin-top: 20px;">없음</div> <label
							class="custom-file-upload" style="margin-top: 20px;"> <input
								type="file" name="file" onchange="previewImagereg(event)">
								파일 선택
						</label>
						</td>
					</tr>
					<tr>
						<td colspan=2>
							<div class="carregokbutton">
								<button class="carregokbutton1" onsubmit="return carregcall();"
									id="regcar">등록</button>
							</div>
						</td>
					</tr>
	...
	<div id="updatecarpopup01">
		...
		<div>
			<div>
				<form action="admin.car.update.do" method="post"
					name="carupdateform" onsubmit="return carupdatecall();"
					...
					<table border="1" class="">
						...
						<tr>
							<td style="background-color: #3399ff; text-align: center;">차종</td>
							<td><input name="c_name" id="c_name_u"
								style="width: 180px; height: 30px;"> <input
								type="hidden" name="c_id" id="c_id_u"></td>
						</tr>
						<tr>
							<td style="background-color: #3399ff; text-align: center;">연식</td>
							<td><input name="c_year1" id="c_year1_u"
								style="width: 180px; height: 30px;"> ~<input
								name="c_year2" id="c_year2_u"
								style="width: 180px; height: 30px;"></td>
						</tr>
						<tr>
							<td style="background-color: #3399ff; text-align: center;">출력</td>
						...
						<tr>
							<td style="background-color: #3399ff; text-align: center;">타이어사이즈</td>
							<td>
								<button type="button" onclick="addupdateSize()"
									class="admin_tire_size_button">사이즈 추가</button>
						...
						<tr>
							...
							<td>
								<div class="preview-image" style="float: left;">
									<div class="upload-display" style="float: left;">
										<div class="upload-thumb-wrap" style="float: left;">
											<img class="c_img_css" id="carImg"
												src="resources/web/(기존에 저장된 파일명)"> <img
												class="update-upload-thumb">
										</div>
									</div>
								</div>
								<div class="updatefileinputstyle"
									style="float: left; margin-top: 20px;">없음</div> <label
								class="custom-file-upload" style="margin-top: 20px;"> <input
