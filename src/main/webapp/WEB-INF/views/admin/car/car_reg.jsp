			...
			<form action="admin.car.reg.do" id="admin_tire_table_container"
				...
				<table id="admin_tire_table" border="1">
					...
					<tr>
						...
						<td>
						<input type="text" name="c_name" id="admin-tire-reg-name-input"required="required" /></td>
					</tr>
					<tr>
						<td class="admin_tire_table_title">연식</td>
						<td>
							<input name="c_year1" class="admin_car_reg_year"oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength='4'required="required"> &nbsp;~&nbsp; 
							<input name="c_year2"class="admin_car_reg_year"oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength='4'required="required">
						</td>
					</tr>
					<tr>
