...
public class MyOrderDTO {
	...
	public MyOrderDTO(String o_no, String o_sortation, String o_ordernumber, String o_orderdate, String o_ordername,
			String o_product, List<CartDTO> productList, String o_price, String o_paymethod, String o_deliverymethod,
			String o_step, String o_storeshop, String o_tireinstalldate, String o_name, String o_phone, String o_email,
	...
	public void setProductList(List<CartDTO> productList) {
		this.productList = productList;
	}
	...
	public String toString() {
		return "MyOrderDTO [o_no=" + o_no + ", o_sortation=" + o_sortation + ", o_ordernumber=" + o_ordernumber
				+ ", o_orderdate=" + o_orderdate + ", o_ordername=" + o_ordername + ", o_product=" + o_product
				+ ", productList=" + productList + ", o_price=" + o_price + ", o_paymethod=" + o_paymethod
